          ...
          return (
            ...
            >
              <div className="flex items-center justify-between">
                <span
                  className={`text-xs ${isToday ? "text-orange-400 font-semibold" : "text-neutral-400"}`}
                >
                  {format(d, "d")}
                </span>
                {acts.length > 1 && (
              ...
              <ul className="mt-1.5 space-y-1">
                {acts.slice(0, view === "week" ? 6 : 3).map((a) => (
                  <li key={a.id}>
                    <button
                ...
                {acts.length > (view === "week" ? 6 : 3) && (
                  <li className="text-[10px] text-neutral-500 px-1.5">
                    +{acts.length - (view === "week" ? 6 : 3)} more
                  </li>
                )}
              </ul>
            </div>
